...
Set the output path to `/home/jovyan/Voxelwise-Walkthroughs/outputs/sub-10015_sharedreward_mb3me1_L1`. FEAT will append `.feat`. The name captures participant, task, acquisition, and level while remaining independent of the source data directory.
